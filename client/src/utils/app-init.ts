      ...
      try {
        await keycloak.init({
          ...
          initOptions: {
            ...
            //   If is set to 'login-required' this means your browser will do a full redirect
            //   to the Keycloak server and back to your application.
            //   If is set to  'check-sso'  instead this action will be performed in a hidden iframe,
            //   so your application resources only need to be loaded and parsed once by the browser.
