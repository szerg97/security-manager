...
public class SecurityController {
    ...
    public ResponseEntity<Security> getOneDistributor(
    ...
    public ResponseEntity<Security> deleteOneDistributor(
            @Parameter (name = "id", required = true)
            @PathVariable(name = "id", required = true) Long id){
    ...
    @PostMapping("")
    public ResponseEntity<Security> addOneDistributor(
            @Valid
    ...
    @PutMapping("")
    public ResponseEntity<Security> updateOneDistributor(
            @Parameter (name = "security", required = true)
            @RequestBody (required = true) Security security){
